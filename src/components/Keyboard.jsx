...
const Keyboard = ({ usedKeys, setCurrentGuess, currentGuess, handleKeydown }) => {
  ...
  const Key = ({ label, value, isSpecial }) => {
    ...
    const baseClass = 'cursor-pointer m-1.5 rounded-lg leading-12 font-bold uppercase text-xl inline-block text-center bg-gray-200 transition-all duration-200'
    const specialClass = isSpecial ? 'px-4 py-2 min-w-[2rem] md:min-w-[5rem] text-sm bg-gray-300' : 'w-6 md:w-[3rem]'
    return (
  ...
  return (
    <div className='w-full md:max-w-screen m-[20px_auto]'>
      ...
      <div className=' flex justify-center items-center'>
        ...
        <div className='keyboard-row flex mx-2'>
